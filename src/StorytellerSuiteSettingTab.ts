...
import { gerarAlertasScrivener, type AlertaScrivener } from './contrarius/scrivener-alerts-panel-model';
...
export class StorytellerSuiteSettingTab extends PluginSettingTab {
    ...
    private renderScrivenerTab(container: HTMLElement): void {
        ...
        container.createEl('p', {
            text: 'Initial Contrarius/Scrivener bridge. This preview is generated by the Scrivener alerts model and will be connected to real package/apply/restore state in the next phase.',
            cls: 'setting-item-description',
        });
        ...
        new Setting(container)
            ...
            .setDesc('The Scrivener alerts model is now rendered in the settings UI. The next phase will feed this panel with the real Scrivener package state.');
    }
